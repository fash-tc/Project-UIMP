  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute left-0 top-full pt-1 hidden group-hover:block z-50">
        <div className="bg-surface border border-border rounded-lg shadow-xl py-1 min-w-[180px]">
          {items.map(item => (
            <a
              key={item.href}
              href={item.href}
...
function NavBar() {
  return (
    <div className="flex items-center gap-1">
      ...
      <NavDropdown label="Statuspage" href="/portal/status" items={[
        { href: '/portal/status', label: 'Public Status' },
        { href: '/portal/status/incidents', label: 'Incidents' },
        { href: '/portal/status/incidents?tab=new', label: 'New Incident' },
        { href: '/portal/status/admin', label: 'Components & Settings' },
      ]} />
      <NavDropdown label="Settings" href="/portal/settings" items={[
        ...
        { href: '/portal/settings/noc-bot', label: 'NOC Bot Controls' },
      ]} />
      <a
        href="/portal/ai-chat"
...
export default function AppChrome({ children }: { children: React.ReactNode }) {
  ...
  const standaloneStatus = pathname === '/status' || pathname === '/status/';
